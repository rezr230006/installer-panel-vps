...
# DENGAN PHPMYADMIN OTOMATIS + DATABASE FIX TOTAL
...
echo "    ║   ██   ██   ███ ███     ██      ██ ███████ ██████  ██████    ║"
echo "    ║                                                               ║"
echo "    ║         🌟 PREMIUM EDITION - ULTIMATE FIX 🌟                  ║"
...
echo -e "${YELLOW}[3/12] 🗄️  Menginstall MariaDB...${NC}"
...
echo -e "${GREEN}✅ MariaDB terinstall dengan password: ${DB_PASSWORD}${NC}"
echo ""
...
echo "    ║                                                               ║"
echo "    ║         RW MLBB VPN PANEL - ULTIMATE EDITION                 ║"
echo "    ║         DENGAN PHPMYADMIN OTOMATIS                           ║"
echo "    ║                                                               ║"
echo "    ╚═══════════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
echo -e "🔑 ${WHITE}Password:${NC} ${YELLOW}${DB_PASSWORD}${NC}"
echo ""
echo -e "${GREEN}════════════════════════════════════════════════════════════${NC}"
